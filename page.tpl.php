...
<!-- skip to main content link; hidden from plain view -->
<div id="skip">
  <a href="#mainContent">Skip to Main Content</a>
</div>

<?php if (!empty($banner6)) { echo '<div id="banner6" class="ms-banner6 clearfix">'.render($banner6).'</div>'; } ?>
...
<article class="ms-post ms-article">
                ...
                <div class="ms-postcontent"><?php if (!empty($title)): print '<h1'. ($tabs ? ' class="with-tabs"' : '') .'>'. $title .'</h1>'; endif; ?>
...
<div class="ms-content-layout">
    ...
    <div class="ms-layout-cell" style="width: 100%">
        ...
        <p>Created by <a href="www.mcgrathsolutions.org">McGrath Solutions, Inc.</a></p>
    </div>
    </div>
</div>
